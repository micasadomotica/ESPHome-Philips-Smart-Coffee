...
#define USE_DEFAULT_PHILIPS_COMMAND_SET
        ...
        // The EP3321/40 no-clean sequence has not been confirmed publicly.
        // Use the published Power on message for clean: false instead of PowerPurgeWater.
        ...
        const std::vector<uint8_t> command_press_temperature =
            {0xD5, 0x55, 0x00, 0x01, 0x05, 0x01, 0x16, 0x00, 0x08, 0x00, 0x2A, 0x38};
